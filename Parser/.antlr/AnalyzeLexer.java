...
public class AnalyzeLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "T__3", "GROUP", "NAME", "WS", "ESCAPE", "E_DOLLAR", 
			"E_ESCAPE", "E_COMMA", "DOLLAR", "ANY"
		};
	}
	...
	public AnalyzeLexer(CharStream input) {
		super(input);
